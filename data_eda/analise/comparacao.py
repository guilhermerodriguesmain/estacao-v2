...
class Comparacao:
    ...
    def comparar_umidade(self):
        ...
        df["diferenca_umidade"] = (df["umidade_relativa_iot"] - df["umidade_relativa_openmeteo"])
    ...
    def adicionar_ponto_orvalho(self):
    ...
    def dados_ponto_orvalho(self):

        df = self.comparar_ponto_orvalho()["dados"]
